...
| v6c | Eval v5 → v6 (free score + discretization, JSON, 42 questions) | Reliable thermometer |
...
| LLM-Judge | Free score 0-100 (text) | Free score 0-100 (text) | Free score 0-100 (JSON) + code-side discretization |
