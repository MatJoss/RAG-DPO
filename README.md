...
│  │      │    retrieve+generate par sous-Q      │              │       │
│  │      │    fusion programmatique (0 LLM)     │              │       │
...
| **Agent** | LangGraph 1.0 | Graphe 9 nœuds, query decomposition, fusion programmatique, 5 outils locaux |
...
| Dataset | 18 questions | 18 questions | **42 questions** (5 catégories) | **48 questions** (5 cat. + 6 composites) |
