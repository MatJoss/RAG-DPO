...
2. **Phase 2** : LLM-as-Judge avec paliers fixes (0/30/50/70/85/100) en JSON structuré
...
| v6c | Eval v5 → v6 (paliers fixes, JSON, 42 questions) | Thermomètre fiable |
...
| LLM-Judge | Score libre 0-100 | Score libre 0-100 | Paliers fixes 0/30/50/70/85/100 (JSON) |
